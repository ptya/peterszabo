...
const Fail: React.FC = () => (
  <Cross width="70" height="70" viewBox="0 0 70 70">
    ...
    />
    <circle id="failAnimationCircle" cx="35" cy="35" r="24" strokeWidth="3" strokeLinecap="round" fill="transparent" />
    <line id="failAnimationCross1" x1="25" y1="25" x2="45" y2="45" strokeWidth="3" fill="transparent" />
    <line id="failAnimationCross2" x1="45" y1="25" x2="25" y2="45" strokeWidth="3" fill="transparent" />
  </Cross>
)
